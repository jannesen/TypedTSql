...
namespace Jannesen.Language.TypedTSql.BuildIn.Func
{
    ...
    public class COUNT_BIG: ExprCalculationBuildIn
    {
        ...
        internal                                            COUNT_BIG(Internal.BuildinFunctionDeclaration declaration, Core.ParserReader reader): base(declaration, reader)
        {
