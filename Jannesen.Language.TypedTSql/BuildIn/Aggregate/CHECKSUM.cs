...
{
    public class CHECKSUM: ExprCalculationBuildIn
    {
        ...
        internal                                            CHECKSUM(Internal.BuildinFunctionDeclaration declaration, Core.ParserReader reader): base(declaration, reader)
        {
