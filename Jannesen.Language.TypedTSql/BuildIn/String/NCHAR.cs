...
{
    public class NCHAR: Func_Scalar
    {
        internal                                            NCHAR(Internal.BuildinFunctionDeclaration declaration, Core.ParserReader reader): base(declaration, reader)
        {
        }
        ...
        protected   override    DataModel.ISqlType          TranspileReturnType(IExprNode[] arguments)
        {
            ...
            if (sqlType is DataModel.SqlTypeAny)
                return new DataModel.SqlTypeNative(DataModel.SystemType.NChar, maxLength:1);
