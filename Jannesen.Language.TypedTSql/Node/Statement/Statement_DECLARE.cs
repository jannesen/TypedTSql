        ...
        public class VariableTypeValue: Core.AstParseNode
        {
            ...
            public      override    void                        TranspileNode(Transpile.Context context)
            {
                ...
                if (n_Type.SqlType != null) {
                    ...
                    n_Name.SetSymbolUsage(Variable.Symbol, DataModel.SymbolUsageFlags.Declaration |
                                               (n_Expression != null ? DataModel.SymbolUsageFlags.Write : DataModel.SymbolUsageFlags.None));
                }
